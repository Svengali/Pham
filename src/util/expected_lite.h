...
#ifndef std_EXPECTED_LITE_HPP
#define std_EXPECTED_LITE_HPP
...
#define nsel_REQUIRES_T(...) \
    typename = typename std::enable_if< (__VA_ARGS__), std::expected_detail::enabler >::type
...
namespace std {
    ...
    public:
        ...
        const constexpr error_type && error() const &&
        {
...
namespace std {
    ...
    template< typename T, typename E >
    struct hash< std::expected<T, E> >
    {
        typedef typename hash<T>::result_type result_type;
        typedef std::expected<T, E> argument_type;
    ...
    template< typename E >
    struct hash< std::expected<void, E> >
    {
    };
