...
public class PhamLib : ModuleRules
{
	public PhamLib(ReadOnlyTargetRules Target) : base(Target)
	{
			...
			Target.Platform == UnrealTargetPlatform.Mac || Target.Platform == UnrealTargetPlatform.Linux)
		{
			...
			LibDir += "/pham/" + (bDebug ? "Debug":"Release") + "/";  //"/" + "/pham/" + bDebug?"Debug":"Release";
			...
			PublicIncludePaths.Add(ModuleDirectory + "/src/");
